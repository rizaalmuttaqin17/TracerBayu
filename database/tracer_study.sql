...
-- Dumping data for table tracer_bayu.jawaban: ~0 rows (approximately)
/*!40000 ALTER TABLE `jawaban` DISABLE KEYS */;
/*!40000 ALTER TABLE `jawaban` ENABLE KEYS */;

-- Dumping data for table tracer_bayu.kuisioner: ~0 rows (approximately)
/*!40000 ALTER TABLE `kuisioner` DISABLE KEYS */;
/*!40000 ALTER TABLE `kuisioner` ENABLE KEYS */;

-- Dumping data for table tracer_bayu.kuisioner_pilihan: ~0 rows (approximately)
