...
<?php 
    ...
    $sqlKuisioner = "SELECT id, id_user, id_kuisioner, id_kuisioner_pilihan, jawaban, MAX(created_at) FROM jawaban WHERE id_kuisioner=$idKuisioner GROUP BY jawaban.id_kuisioner_pilihan  ;";
