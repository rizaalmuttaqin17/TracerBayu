...
<?php endblock() ?>">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            ...
            <div class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('foto_profile/<?php echo $dataMahasiswa['foto']; ?>')"></div>
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span class="navi-text text-muted text-hover-primary"><?php echo $dataMahasiswa['email']; ?></span>
                            </span>
                        </a>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                <a href="profile.php" class="navi-item">
                    <div class="navi-link">
